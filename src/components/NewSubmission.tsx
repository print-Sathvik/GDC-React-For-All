...
const initializeForm = async (
  formId: number,
  setFormCB: React.Dispatch<SetStateAction<formData | null>>
) => {
  try {
...
const reducer: (
  ...
  switch (action.type) {
    case "update_answer":
      if (
        state.answers.find(
          (answer) => answer.form_field === action.field_id
        ) === undefined
      ) {
        ...
        return {
          ...
          answers: [
            ...state.answers,
            { form_field: action.field_id, value: action.answer },
          ],
        };
      } else {
        return {
    ...
    case "update_multiselect":
      if (
        ...
        return {
          ...
          answers: [
            ...state.answers,
            { form_field: action.field_id, value: String(action.index) },
          ],
        };
      }
      return {
