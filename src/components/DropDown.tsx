    ...
    <div key={props.id} className="inputSet relative w-full mt-[30px]">
      <div className="flex">
        ...
        <input
          ...
          className="absolute left-0 bottom-3 z-[1] text-[#8f8f8f] pt-1 px-2.5 m-0 peer-hover:text-[#45f3ff] peer-focus:text-[#45f3ff] peer-valid:text-[#45f3ff] peer-focus:-translate-y-8 peer-valid:-translate-y-8 peer-focus:text-[12px] peer-valid:text-[12px]"
        />
